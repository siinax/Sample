...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    public long clicktime = TitleVar.CLICK_INTERVAL;
...
//        int rightSubIcon = typedArray.getResourceId(R.styleable.TitleBar_rightSubIcon, 0);
        ...
        titlebar.setBackgroundColor(ContextCompat.getColor(context, TitleVar.TITLE_BOLOR_BG));
